...
public class MemoTabDTO {
	...
	private GeneralTabDTO genTabDTO;
	private MemoTabDTO memoTabDTO;
	...
	public GeneralTabDTO getGenTabDTO() {
		return genTabDTO;
	}
	public void setGenTabDTO(GeneralTabDTO genTabDTO) {
		this.genTabDTO = genTabDTO;
	}
	public MemoTabDTO getMemoTabDTO() {
		return memoTabDTO;
	}
	public void setMemoTabDTO(MemoTabDTO memoTabDTO) {
		this.memoTabDTO = memoTabDTO;
	}
	@Override
	public String toString() {
		return "MemeoTabDTO [ciNfId=" + ciNfId + ", ciCountryId=" + ciCountryId + ", ciRoleId=" + ciRoleId
				+ ", ciOutBIC=" + ciOutBIC + ", ciRefNo=" + ciRefNo + ", ciSsn=" + ciSsn + ", ciGenderId=" + ciGenderId
				+ ", gender=" + gender + ", seNfid=" + seNfid + ", seOutBIC=" + seOutBIC + ", seGenderId=" + seGenderId
				+ ", seCountryId=" + Arrays.toString(seCountryId) + ", country=" + Arrays.toString(country) + ", info="
				+ info + ", genTabDTO=" + genTabDTO + ", memoTabDTO=" + memoTabDTO + "]";
	}
